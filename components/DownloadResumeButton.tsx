...
export default function DownloadResumeButton({ pdfPath, fileName }: DownloadResumeButtonProps) {
  return (
    <a
      href={pdfPath}
      download={fileName}
      className="w-full flex justify-between items-center px-10 py-8 bg-foreground text-background rounded-[32px] group border-2 border-transparent hover:bg-transparent hover:border-foreground hover:text-foreground hover:scale-[1.02] transition-all shadow-xl"
    >
